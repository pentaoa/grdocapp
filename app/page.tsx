...
export default async function HomePage() {
  return (
    <section>
      ...
      <h1 className="font-bold text-5xl dark:text-neutral-200">{name} - 个人网站</h1>
      ...
      <p className="my-4 text-2xl font-semibold italic text-slate-900">
      <span className="w-min h-min absolute -inset-1 -skew-y-3 bg-pink-500">
          <span className="relative text-white">船新版本</span>
      </span>        
